"""Port of multi/fuzzySetActivity/FuzzySetActivity.java."""
...
__all__ = ["FuzzySetActivity"]


class FuzzySetActivity(MultiVariable):
    """A MultiVariable pairing an AllenInterval (quantitative temporal
