"""Port of examples/TestQualitativeAllenConstraintSolverUNSAT.java.
...
def main() -> None:
    ...
    con0 = QualitativeAllenIntervalConstraint(Type.Before)
    con0.from_ = re0
    con0.to = re1

    con1 = QualitativeAllenIntervalConstraint(Type.Before)
    con1.from_ = re1
    con1.to = re2

    con2 = QualitativeAllenIntervalConstraint(Type.Before)
    con2.from_ = re2
    con2.to = re0
